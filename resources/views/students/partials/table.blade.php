                ...
                <tr class="hover:bg-white/10 transition-colors glass-card">
                    ...
                    <td>
                        <div class="flex gap-1 shrink-0">
                            ...
                            <button type="button" @click="confirmDelete('{{ route('students.destroy', $student) }}')" class="btn btn-sm btn-ghost hover:bg-error/20 text-white/70 hover:text-error transition-all duration-300 rounded-lg group" title="Delete Student">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
